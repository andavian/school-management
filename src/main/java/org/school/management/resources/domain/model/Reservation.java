// src/main/java/org/school/management/resources/domain/model/Reservation.java
...
public class Reservation {
    ...
    private final UUID requesterId;           // ← Cambiado de UserId a UUID (regla CLAUDE.md)
    ...
    private UUID cancelledBy;                 // ← Cambiado de UserId a UUID
    ...
    public static Reservation create(ResourceId resourceId, UUID requesterId, String requesterName,
    ...
    public void cancel(UUID cancelledBy, String reason) {        // ← UUID en lugar de UserId
    ...
    public void assignUnit(ResourceUnit unit) {
        ...
        if (!unit.getResourceId().equals(this.resourceId)) {
            throw new IllegalArgumentException("Unit does not belong to the same resource");
        }
        ...
        ReservationUnit ru = ReservationUnit.create(
                ReservationUnitId.generate(),
                this.reservationId,
                unit.getUnitId()
        );
    ...
    // Método de ownership (importante para seguridad)
    public boolean belongsToRequester(UUID userId) {
