 ...
 *   - 44 cursos: 1°-2° con divisiones A/B/C/D, 3°-6° con A/B/C, 7° con A/B — por cada año lectivo
...
public class AcademicDataSeeder implements ApplicationRunner {
    ...
    // =========================================================================
    // UUIDs FIJOS — Academic Years
    // =========================================================================
    public static final UUID ACADEMIC_YEAR_2024_ID = UUID.fromString("ac000000-0000-0000-0000-000000002024");
    public static final UUID ACADEMIC_YEAR_2025_ID = UUID.fromString("ac000000-0000-0000-0000-000000002025");

    // =========================================================================
    // UUIDs FIJOS — Orientations
    // =========================================================================
    public static final UUID ORIENTATION_ELECTRICISTA_ID    = UUID.fromString("or000000-0000-0000-0000-000000000001");
    public static final UUID ORIENTATION_ELECTROMECANICO_ID = UUID.fromString("or000000-0000-0000-0000-000000000002");

    // =========================================================================
    // UUIDs FIJOS — Grade Levels 2025
    // Patrón: gl25-AADD (AA = año, DD = división)
    // 1°A-D, 2°A-D, 3°A-C, 4°A-C, 5°A-C, 6°A-C, 7°A-B
    // =========================================================================
    public static final UUID GL_2025_1A = UUID.fromString("g1250000-0000-0000-0000-000000000101");
    public static final UUID GL_2025_1B = UUID.fromString("g1250000-0000-0000-0000-000000000102");
    public static final UUID GL_2025_1C = UUID.fromString("g1250000-0000-0000-0000-000000000103");
    public static final UUID GL_2025_1D = UUID.fromString("g1250000-0000-0000-0000-000000000104");
    public static final UUID GL_2025_2A = UUID.fromString("g1250000-0000-0000-0000-000000000201");
    public static final UUID GL_2025_2B = UUID.fromString("g1250000-0000-0000-0000-000000000202");
    public static final UUID GL_2025_2C = UUID.fromString("g1250000-0000-0000-0000-000000000203");
    public static final UUID GL_2025_2D = UUID.fromString("g1250000-0000-0000-0000-000000000204");
    public static final UUID GL_2025_3A = UUID.fromString("g1250000-0000-0000-0000-000000000301");
    public static final UUID GL_2025_3B = UUID.fromString("g1250000-0000-0000-0000-000000000302");
    public static final UUID GL_2025_3C = UUID.fromString("g1250000-0000-0000-0000-000000000303");
    public static final UUID GL_2025_4A = UUID.fromString("g1250000-0000-0000-0000-000000000401");
    public static final UUID GL_2025_4B = UUID.fromString("g1250000-0000-0000-0000-000000000402");
    public static final UUID GL_2025_4C = UUID.fromString("g1250000-0000-0000-0000-000000000403");
    public static final UUID GL_2025_5A = UUID.fromString("g1250000-0000-0000-0000-000000000501");
    public static final UUID GL_2025_5B = UUID.fromString("g1250000-0000-0000-0000-000000000502");
    public static final UUID GL_2025_5C = UUID.fromString("g1250000-0000-0000-0000-000000000503");
    public static final UUID GL_2025_6A = UUID.fromString("g1250000-0000-0000-0000-000000000601");
    public static final UUID GL_2025_6B = UUID.fromString("g1250000-0000-0000-0000-000000000602");
    public static final UUID GL_2025_6C = UUID.fromString("g1250000-0000-0000-0000-000000000603");
    public static final UUID GL_2025_7A = UUID.fromString("g1250000-0000-0000-0000-000000000701");
    public static final UUID GL_2025_7B = UUID.fromString("g1250000-0000-0000-0000-000000000702");

    // =========================================================================
    // UUIDs FIJOS — Subjects — Ciclo Básico (1°-3°, sin orientación)
    // =========================================================================
    public static final UUID SUBJ_MATEMATICA_1    = UUID.fromString("sb000000-0000-0000-0000-000000000101");
    public static final UUID SUBJ_LENGUA_1        = UUID.fromString("sb000000-0000-0000-0000-000000000102");
    public static final UUID SUBJ_HISTORIA_1      = UUID.fromString("sb000000-0000-0000-0000-000000000103");
    public static final UUID SUBJ_GEOGRAFIA_1     = UUID.fromString("sb000000-0000-0000-0000-000000000104");
    public static final UUID SUBJ_FISICA_1        = UUID.fromString("sb000000-0000-0000-0000-000000000105");
    public static final UUID SUBJ_QUIMICA_1       = UUID.fromString("sb000000-0000-0000-0000-000000000106");
    public static final UUID SUBJ_ED_FISICA_1     = UUID.fromString("sb000000-0000-0000-0000-000000000107");
    public static final UUID SUBJ_FORMACION_C_1   = UUID.fromString("sb000000-0000-0000-0000-000000000108");
    public static final UUID SUBJ_TECNOLOGIA_1    = UUID.fromString("sb000000-0000-0000-0000-000000000109");
    public static final UUID SUBJ_INGLES_1        = UUID.fromString("sb000000-0000-0000-0000-000000000110");

    public static final UUID SUBJ_MATEMATICA_2    = UUID.fromString("sb000000-0000-0000-0000-000000000201");
    public static final UUID SUBJ_LENGUA_2        = UUID.fromString("sb000000-0000-0000-0000-000000000202");
    public static final UUID SUBJ_HISTORIA_2      = UUID.fromString("sb000000-0000-0000-0000-000000000203");
    public static final UUID SUBJ_GEOGRAFIA_2     = UUID.fromString("sb000000-0000-0000-0000-000000000204");
    public static final UUID SUBJ_FISICA_2        = UUID.fromString("sb000000-0000-0000-0000-000000000205");
    public static final UUID SUBJ_QUIMICA_2       = UUID.fromString("sb000000-0000-0000-0000-000000000206");
    public static final UUID SUBJ_ED_FISICA_2     = UUID.fromString("sb000000-0000-0000-0000-000000000207");
    public static final UUID SUBJ_FORMACION_C_2   = UUID.fromString("sb000000-0000-0000-0000-000000000208");
    public static final UUID SUBJ_TECNOLOGIA_2    = UUID.fromString("sb000000-0000-0000-0000-000000000209");
    public static final UUID SUBJ_INGLES_2        = UUID.fromString("sb000000-0000-0000-0000-000000000210");

    public static final UUID SUBJ_MATEMATICA_3    = UUID.fromString("sb000000-0000-0000-0000-000000000301");
    public static final UUID SUBJ_LENGUA_3        = UUID.fromString("sb000000-0000-0000-0000-000000000302");
    public static final UUID SUBJ_HISTORIA_3      = UUID.fromString("sb000000-0000-0000-0000-000000000303");
    public static final UUID SUBJ_FISICA_3        = UUID.fromString("sb000000-0000-0000-0000-000000000304");
    public static final UUID SUBJ_QUIMICA_3       = UUID.fromString("sb000000-0000-0000-0000-000000000305");
    public static final UUID SUBJ_ED_FISICA_3     = UUID.fromString("sb000000-0000-0000-0000-000000000306");
    public static final UUID SUBJ_FORMACION_C_3   = UUID.fromString("sb000000-0000-0000-0000-000000000307");
    public static final UUID SUBJ_TECNOLOGIA_3    = UUID.fromString("sb000000-0000-0000-0000-000000000308");
    public static final UUID SUBJ_INGLES_3        = UUID.fromString("sb000000-0000-0000-0000-000000000309");
    public static final UUID SUBJ_DIBUJO_TEC_3    = UUID.fromString("sb000000-0000-0000-0000-000000000310");

    // =========================================================================
    // UUIDs FIJOS — Subjects — Ciclo Orientado ELECTRICISTA (4°-7°)
    // =========================================================================
    public static final UUID SUBJ_EELEC_MAT_4     = UUID.fromString("sb000000-0000-0000-0000-000000000401");
    public static final UUID SUBJ_EELEC_FISICA_4  = UUID.fromString("sb000000-0000-0000-0000-000000000402");
    public static final UUID SUBJ_EELEC_LENGUA_4  = UUID.fromString("sb000000-0000-0000-0000-000000000403");
    public static final UUID SUBJ_EELEC_ELEC_4    = UUID.fromString("sb000000-0000-0000-0000-000000000404");
    public static final UUID SUBJ_EELEC_INST_4    = UUID.fromString("sb000000-0000-0000-0000-000000000405");
    public static final UUID SUBJ_EELEC_DIBUJO_4  = UUID.fromString("sb000000-0000-0000-0000-000000000406");
    public static final UUID SUBJ_EELEC_ED_FIS_4  = UUID.fromString("sb000000-0000-0000-0000-000000000407");

    public static final UUID SUBJ_EELEC_MAT_5     = UUID.fromString("sb000000-0000-0000-0000-000000000501");
    public static final UUID SUBJ_EELEC_FISICA_5  = UUID.fromString("sb000000-0000-0000-0000-000000000502");
    public static final UUID SUBJ_EELEC_ELEC_5    = UUID.fromString("sb000000-0000-0000-0000-000000000503");
    public static final UUID SUBJ_EELEC_MAQUINAS_5= UUID.fromString("sb000000-0000-0000-0000-000000000504");
    public static final UUID SUBJ_EELEC_INST_5    = UUID.fromString("sb000000-0000-0000-0000-000000000505");
    public static final UUID SUBJ_EELEC_ED_FIS_5  = UUID.fromString("sb000000-0000-0000-0000-000000000506");

    public static final UUID SUBJ_EELEC_MAT_6     = UUID.fromString("sb000000-0000-0000-0000-000000000601");
    public static final UUID SUBJ_EELEC_ELEC_6    = UUID.fromString("sb000000-0000-0000-0000-000000000602");
    public static final UUID SUBJ_EELEC_MAQUINAS_6= UUID.fromString("sb000000-0000-0000-0000-000000000603");
    public static final UUID SUBJ_EELEC_PROYECTO_6= UUID.fromString("sb000000-0000-0000-0000-000000000604");
    public static final UUID SUBJ_EELEC_LEGISL_6  = UUID.fromString("sb000000-0000-0000-0000-000000000605");
    public static final UUID SUBJ_EELEC_ED_FIS_6  = UUID.fromString("sb000000-0000-0000-0000-000000000606");

    public static final UUID SUBJ_EELEC_PROYECTO_7= UUID.fromString("sb000000-0000-0000-0000-000000000701");
    public static final UUID SUBJ_EELEC_ELEC_7    = UUID.fromString("sb000000-0000-0000-0000-000000000702");
    public static final UUID SUBJ_EELEC_GESTION_7 = UUID.fromString("sb000000-0000-0000-0000-000000000703");
    public static final UUID SUBJ_EELEC_SEGURIDAD_7=UUID.fromString("sb000000-0000-0000-0000-000000000704");

    // =========================================================================
    // UUIDs FIJOS — Subjects — Ciclo Orientado ELECTROMECANICO (4°-7°)
    // =========================================================================
    public static final UUID SUBJ_EMEC_MAT_4      = UUID.fromString("sb000000-0000-0000-0000-000000000411");
    public static final UUID SUBJ_EMEC_FISICA_4   = UUID.fromString("sb000000-0000-0000-0000-000000000412");
    public static final UUID SUBJ_EMEC_LENGUA_4   = UUID.fromString("sb000000-0000-0000-0000-000000000413");
    public static final UUID SUBJ_EMEC_MECANICA_4 = UUID.fromString("sb000000-0000-0000-0000-000000000414");
    public static final UUID SUBJ_EMEC_TERMOT_4   = UUID.fromString("sb000000-0000-0000-0000-000000000415");
    public static final UUID SUBJ_EMEC_DIBUJO_4   = UUID.fromString("sb000000-0000-0000-0000-000000000416");
    public static final UUID SUBJ_EMEC_ED_FIS_4   = UUID.fromString("sb000000-0000-0000-0000-000000000417");

    public static final UUID SUBJ_EMEC_MAT_5      = UUID.fromString("sb000000-0000-0000-0000-000000000511");
    public static final UUID SUBJ_EMEC_FISICA_5   = UUID.fromString("sb000000-0000-0000-0000-000000000512");
    public static final UUID SUBJ_EMEC_MECANICA_5 = UUID.fromString("sb000000-0000-0000-0000-000000000513");
    public static final UUID SUBJ_EMEC_MAQUINAS_5 = UUID.fromString("sb000000-0000-0000-0000-000000000514");
    public static final UUID SUBJ_EMEC_HIDRO_5    = UUID.fromString("sb000000-0000-0000-0000-000000000515");
    public static final UUID SUBJ_EMEC_ED_FIS_5   = UUID.fromString("sb000000-0000-0000-0000-000000000516");

    public static final UUID SUBJ_EMEC_MAT_6      = UUID.fromString("sb000000-0000-0000-0000-000000000611");
    public static final UUID SUBJ_EMEC_MAQUINAS_6 = UUID.fromString("sb000000-0000-0000-0000-000000000612");
    public static final UUID SUBJ_EMEC_MECANICA_6 = UUID.fromString("sb000000-0000-0000-0000-000000000613");
    public static final UUID SUBJ_EMEC_PROYECTO_6 = UUID.fromString("sb000000-0000-0000-0000-000000000614");
    public static final UUID SUBJ_EMEC_LEGISL_6   = UUID.fromString("sb000000-0000-0000-0000-000000000615");
    public static final UUID SUBJ_EMEC_ED_FIS_6   = UUID.fromString("sb000000-0000-0000-0000-000000000616");

    public static final UUID SUBJ_EMEC_PROYECTO_7 = UUID.fromString("sb000000-0000-0000-0000-000000000711");
    public static final UUID SUBJ_EMEC_MAQUINAS_7 = UUID.fromString("sb000000-0000-0000-0000-000000000712");
    public static final UUID SUBJ_EMEC_GESTION_7  = UUID.fromString("sb000000-0000-0000-0000-000000000713");
    public static final UUID SUBJ_EMEC_SEGURIDAD_7= UUID.fromString("sb000000-0000-0000-0000-000000000714");

    // =========================================================================
    // UUIDs FIJOS — Qualification Registries
    // =========================================================================
    public static final UUID REGISTRY_2024_ID = UUID.fromString("rg000000-0000-0000-0000-000000002024");
    public static final UUID REGISTRY_2025_ID = UUID.fromString("rg000000-0000-0000-0000-000000002025");
