...
@Slf4j
@Transactional
public class CloseAcademicYearUseCase {
    ...
    public AcademicYearResponse execute(String academicYearId) {
        ...
        AcademicYear closed = activationService.closeYear(id);

        log.info("Academic year closed: {}", closed.getYearValue());
        return mapper.toAcademicYearResponse(closed);
    }
}
